 ...
 *
 */
public class MoppyConstants {

	/**
	 * privateコンストラクタでインスタンス生成を抑止
	 */
	private MoppyConstants() {
	}
	...
	// ==================================================================================================================
	/** 【PC】:ログインURL */
	public static final String PC_LOGIN_URL = "https://ssl.pc.moppy.jp/login/";
	/** 【PC】:ゲームコンテンツURL */
	...
	/** 【PC】:ゲームコンテンツURL */
	public static final String PC_CM_URL = "http://pc.moppy.jp/forward/?t=12489";
	// ==================================================================================================================
	// アカウント情報
	// ==================================================================================================================
	/** 【PC】:ログインメールアドレス */
	public static final String PC_LOGIN_MAIL = "kim-c@softbank.ne.jp";
	/** 【PC】:ログインパスワード */
	...
	// ==================================================================================================================
	/** 【PC】:新規登録URL */
	public static final String PC_REGISTER_URL = "http://moppy.jp/top.php?xGVJe1dd";
	/** 【PC】:会員登録URL */
	public static final String PC_SELECT_URL = "http://pc.moppy.jp/entry/select.php";
	/** 【PC】:使い捨てメールURL */
	 ...
	 *
	 */
	public static List<Integer> getSexList() {
